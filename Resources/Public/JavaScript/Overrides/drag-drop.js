...
class DragDrop {
    ...
    static onDrop(e) {
        ...
        const contentElementUid = parseInt(draggedElement.dataset.uid, 10);
     ...
     * @private
     */
    static ajaxAction(dropContainer, draggedElement, parameters, isCopyAction) {
...
DragDrop.draggableContentIdentifier = '.t3js-page-ce-sortable';
DragDrop.draggableContentHandleIdentifier = '.t3js-page-ce-draghandle';
DragDrop.draggableContentCloneIdentifier = '[data-dragdrop-clone]';
